	...
	return(
		...
		<div className='m-5'>
				...
				w-[80%] mx-auto'>
					...
					<p
					className='mt-5 font-normal text-[18px] sm:text-2xl lg:text-3xl'
				...
				w-[80%] mx-auto'>
					...
					<ul className='mt-5 font-normal text-[18px] sm:text-2xl lg:text-3xl'>
						<li>	Основные цели разработки этого сайта:
						</li>
						<li>• Изучение React+tsx, mobx и отзывчивых 
					 интерфейсов, работа с API и т.д.📚.
					</li>
						<li>	• Практика применения базовых принципов веб-дизайна 🎨.</li>
						<li>	• Освоение работы с react, ts, mobx, axios ⚙️.
						</li>
					</ul>
